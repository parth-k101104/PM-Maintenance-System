...
const styles = StyleSheet.create({
  ...
  healthValue: { fontFamily: "Jost_500Medium", fontSize: 42, color: "#111111", marginTop: 2 },
  healthMetaBox: { alignItems: "flex-end" },
  healthMetaLabel: { fontFamily: "Jost_400Regular", fontSize: 12, color: "#36503A" },
  healthMetaValue: { fontFamily: "Jost_500Medium", fontSize: 16, color: "#111111", marginTop: 2 },
  healthTrendCard: {
    borderRadius: 18,
  ...
  healthTrendTitle: { fontFamily: "Jost_500Medium", fontSize: 16, color: "#111111" },
  healthTrendMeta: { fontFamily: "Jost_400Regular", fontSize: 12, color: "#626781", marginTop: 2 },
  healthTrendValue: { fontFamily: "Jost_500Medium", fontSize: 24, color: "#111111" },
  ...
  equipmentScoreText: { fontFamily: "Jost_500Medium", fontSize: 12, color: "#36503A" },
  ...
  insightSeverity: { fontFamily: "Jost_500Medium", fontSize: 12, color: "#B42318" },
  ...
  metricValue: { fontFamily: "Jost_500Medium", fontSize: 15, color: "#111111", marginTop: 2 },
  ...
  predictionRisk: { fontFamily: "Jost_500Medium", fontSize: 20 },
